<template>
	<!-- 精灵拓展 -->
	<view class="expand_sptite" :style="style" :id="name" :class="'group_' + group">
		<slot :style_sub="style_sub">
			<image :src="src" alt="" v-if="tag === 'img' || src" :style="style_sub">
			...
			<view class="block" v-else v-html="text" :style="style_sub"></view>
		</slot>
	</view>
</template>
