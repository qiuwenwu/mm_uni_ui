<template>
	<view class="control_upload_img" v-bind:class="{ 'upload_add': !bg && !value }">\t<view @click="choose()">
		...
		<mm_modal v-model="preview" mask="true">
			<view class="preview_img"><image :src="value" style="max-width:100%" :alt="name" /></view>
